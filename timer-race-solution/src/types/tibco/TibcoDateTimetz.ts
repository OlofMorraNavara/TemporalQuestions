...
export class TibcoDateTimetz {
    ...
    public static now(): TibcoDateTimetz {
        const now = DateTime.now();
        return new TibcoDateTimetz(now.year, now.month, now.day, now.hour, now.minute, now.second, now.millisecond);
    }
