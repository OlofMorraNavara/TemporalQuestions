...
export class DateTimeUtil {
  ...
  public static createDate(
    ...
    if (yearOrDate === undefined) {
      ...
      yearOrDate instanceof TibcoDateTime ||
      yearOrDate instanceof TibcoDateTimetz
    ) {
  ...
  public static createDuration(
    ...
    if (
      ...
      typeof yearsMillisecondsOrLexical === "number" && months === undefined
    ) {
